...
const PortPage = (props) => (
      <div className="port-page-body page-body">
        ...
        <div className="port-page-links">
          <h1><i className="fa fa-external-link"></i><a href={props.data.links[1]} target="_blank">{props.data.links[0]}</a></h1>
          <h1><i className="fa fa-github-alt"></i><a href={props.data.links[3]} target="_blank">{props.data.links[2]}</a></h1>
        </div>
        <div className="arrow">
